        ...
        rules.forEach(function(rule) {
            ...
            rule.declarations && rule.declarations.forEach(function(declaration) {
                ...
                if(declaration.property == 'background'){
                    var bgs = background.analyse(declaration.value);
                    var bgPostions = [];
                    _.each(bgs, function(bg){
                        var imageUrl = getImageUrl(bg['background-images']);
...
function replaceCss(){
    ...
    // cssFiles.forEach(function(cssFile){
        ...
        var str = file.read('../nopo-test3/css/test.css');
        ...
        var rules = updateRulesBackground(ast.stylesheet.rules);
