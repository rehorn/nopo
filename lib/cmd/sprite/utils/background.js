 ...
 * refer: https://github.com/iazrael/ispriter/blob/master/src/BackgroundInterpreter.js
...
(function(){
    ...
    var MATCH_ACTION = [
    {
        ...
        exec: function (style, match) {
            ...
            style['background-position'] = cur.join(' ');
        }
    },{
        //background-position
        ...
        exec: function (rule, match) {
            ...
            style['background-position'] = match[0] + ' 50%';
        }
    },{
