...
//		}
	 ...
	 */
	{
		...
		_html :    '<div id="ConsoleBoxHead" class="consoleBoxHead">\
						<button id="ConsoleCloseButton" class="consoleCloseButton" title="关闭">X</button>\
						<button id="ConsoleClearButton" class="consoleCloseButton" title="清除所有日志">cls</button>\
						<button id="ConsoleRefreshButton" class="consoleCloseButton" title="还原所有日志">r</button>\
						<button id="ConsoleHelpButton" class="consoleCloseButton" title="控制台帮助">H</button>\
